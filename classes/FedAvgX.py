...
class FedAvg:
    ...
    def __init__(self, args: Dict[str, Any]):
        ...
        elif self.args.model_name == "our_model":
            self.root_model = Model(input_size=784, hidden_sizes=[128, 64], output_size=10, loss_fn_name='cross_entropy', acti=nn.ReLU()).to(self.device)
